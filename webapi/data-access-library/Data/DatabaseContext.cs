...
public class AghanimsFantasyContext : IdentityDbContext<AghanimsFantasyUser>
{
    ...
    #region Discord
    public DbSet<DiscordOutbox> DiscordOutbox { get; set; }
    ...
    public DbSet<FantasyPlayerBudgetProbability> FantasyPlayerBudgetProbabilityView { get; set; }
    public DbSet<FantasyPlayerBudgetProbabilityTable> FantasyPlayerBudgetProbability { get; set; }
    public DbSet<AccountHeroCount> FantasyAccountTopHeroesView { get; set; }
    public DbSet<FantasyPrivateLeaguePlayer> FantasyPrivateLeaguePlayers { get; set; }
    public DbSet<FantasyLedger> FantasyLedger { get; set; }
    public DbSet<FantasyPrize> FantasyPrizes { get; set; }
    #endregion
