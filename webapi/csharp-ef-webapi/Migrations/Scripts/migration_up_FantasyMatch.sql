...
CREATE TABLE nadcl.fantasy_match_player (
    ...
    CONSTRAINT "FK_fantasy_match_player_dota_accounts_AccountId" FOREIGN KEY ("AccountId") REFERENCES nadcl.dota_accounts (id) ON DELETE CASCADE,
...
VALUES ('20240611225940_FantasyMatch', '8.0.1');
