...
internal class DotaWebApiOperationLauncher<T> where T : DotaOperationContext
{
    // Dependencies
    ...
    public DotaWebApiOperationLauncher(IServiceProvider serviceProvider, TimeSpan coolDown, Uri baseUri, Dictionary<string, string> baseQuery, RateLimiter rateLimiter, CancellationToken stoppingToken)
    {
