...
internal class DataLayerOperationLauncher<T> where T : DotaOperationContext
{
    // Dependencies
    ...
    public DataLayerOperationLauncher(IServiceProvider serviceProvider, TimeSpan coolDown, RateLimiter rateLimiter, CancellationToken stoppingToken)
    {
