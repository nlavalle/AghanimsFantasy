...
create table nadcl.dota_leagues_backup as
select * from nadcl.dota_leagues;

create table nadcl.dota_fantasy_players_backup as
select * from nadcl.dota_fantasy_players;
...
select *
from nadcl.dota_leagues_backup;
...
delete from nadcl.dota_leagues
where league_name not in ('NADCL SEASON 5','NADCL Season 6');

update nadcl.dota_leagues
set id = 16077
where league_name = 'NADCL Season 6';

update nadcl.dota_leagues
set id = 15843
where league_name = 'NADCL SEASON 5';

insert into nadcl.dota_fantasy_leagues (
    id, 
    league_id,
    league_name,
    is_active,
    fantasy_draft_locked_date,
    league_start_time,
    league_end_time
)
select id, league_id, league_name, is_active, fantasy_draft_locked_date, league_start_time, league_end_time
from nadcl.dota_leagues_backup;
